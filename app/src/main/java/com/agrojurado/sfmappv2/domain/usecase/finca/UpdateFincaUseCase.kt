...
class UpdateFincaUseCase @Inject constructor(private val repository: FincaRepository) {
    suspend operator fun invoke(finca: Finca) = repository.updateFinca(finca)
}