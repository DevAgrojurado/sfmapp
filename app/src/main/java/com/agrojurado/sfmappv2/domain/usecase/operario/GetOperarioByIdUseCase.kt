...
class GetOperarioByIdUseCase @Inject constructor(private val repository: OperarioRepository) {
    suspend operator fun invoke(id: Int): Operario? = repository.getOperarioById(id)
